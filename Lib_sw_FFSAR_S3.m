function [original_wf, regenerated_wf, tracker_range, scalefactor, sat_alt]=Lib_sw_FFSAR_S3(input_file_FFSAR,LAT,LON,Ref_Waveform,segmentation)
...
rad=45/110000; %% In order to find closest burst I defined a region with radius of 50 meter around desired point
...
% sat_alt=alt(CoB)+self.radial_velocity*self.eta[self.n_sl_output//self.n_multilook//2::self.n_sl_output//self.n_multilook]
sat_alt=alt(CoB)+radial_velocity*eta(CoB-1);
