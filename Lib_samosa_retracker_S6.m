       function [WL] = Lib_samosa_retracker_S6(wf,tracker_range, sat_alt, correction,GEO)
...
% %         """
    ...
    RDB.Npulse=256;                         % number of the range gates per pulse (without zero-padding)
    RDB.PRF_SAR=9195;                       % Pulse Repetition Frequency in SAR mode , given in Hz
    RDB.BRI=0.007180;                       % Burst Repetition Interval, given in sec
    RDB.f_0=13.575e9;                       % Carrier Frequency in Hz
    RDB.Bs=395e6;                           % Sampled Bandwidth in Hz
...
WL=sat_alt-tracker_range - (epoch_sec-tau)*C/2 -correction;
